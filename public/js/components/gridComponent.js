...
//     render: function() {
//     console.log(".. I'm inside the Home component ..");
//         return (
//             <div className="container">
//                 <h1>Kango</h1>
//                 <p>There you go</p>
//                 <img src={'https://d13yacurqjgara.cloudfront.net/users/6037/screenshots/1965251/solehab.png'} clasName="imgHi">
...
// var shelters = [
//   {
//     name: "Berkeley Animal Rescue",
//     address: "145 Doober St.",
//     city: "Berkeley"
//   },
//   {
//     name: "San Francisco Paws",
//     address: "520 Larkin Ave",
//     city: "San Francisco"
//   }
// ];
...
//     getInitialState: function() {
//         return {
//             shelters: this.props.shelters.splice(0);
//         }
//     },
//     render: function() {
//         return (
//             <div className="container">
//               {this.state.shelters.map(function (shelter) {
//                 return (
//                   <Shelter name={shelters.name} address={shelters.address}></Shelter>
//                 )
//               })}
//             </div>
//         )
...
//     <App shelters={shelters}/>, document.getElementById('content')
// );
